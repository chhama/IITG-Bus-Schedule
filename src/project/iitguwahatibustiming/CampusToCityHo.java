...
public class CampusToCityHo extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_campus_to_city_ho);
		TextView display;
		...
		Calendar rightNow = Calendar.getInstance();
	 	  ...
	 	  if(timenow<8.00){
	 		   ...
	 		   if(weekday==5){
	 			   display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 9:00AM, 10:00AM and 10:30AM");
	 		   }
	 		   else{
	 		   ...
	 		   if(weekday==5){
	 			   display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 10:00AM, 10:30AM and 12:00Noon");
	 		   }
	 		   else{
	 			   display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 10:00AM, 12:00Noon and 1:00PM");
	 		   }
		   }
	 	   else if(timenow>10.00  && timenow <10.30){
	 		   if(weekday==5){
	 			   display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 10:30AM, 12:00Noon and 1:00PM");
	 		   }
	 		   else{
	 			   display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 12:00Noon, 1:00PM and 2:00PM");
	 		   }
	 	   }
	 	   else if(timenow>10.30 && timenow <12.00){
			 	   display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 12:00Noon, 1:00PM and 2:00PM");
	 	   }
	 		  ...
	 		  if(weekday==5){
	 			  display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 2:00PM, 3:00PM and 3:30PM");
	 		  }
	 		  else{
	 		  ...
	 		  if(weekday==5){
	 			  display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 3:00PM, 3:30PM and 4:00PM");
	 		  }
	 		  else{
	 			  display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 3:00PM, 4:00PM and 5:00PM");
	 		  }
		   }
	 	 else if(timenow>15.00 && timenow <15.30){
	 		  if(weekday==5){
	 			  display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 3:30PM, 4:00PM and 5:00PM");
	 		  }
	 		  else{
	 			  display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 4:00PM, 5:00PM and 5:40PM");
	 		  }
		   } 
	 	 else if(timenow>15.30 && timenow <16.00){
	 		 	display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 4:00PM, 5:00PM and 5:40PM");
	 	   }
	 	 else if(timenow>16.00 && timenow <17.00){
	 		 	display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 5:00PM, 5:40PM and 6:45PM");
	 	   }
	 	 else if(timenow>17.00 && timenow <17.40){
	 		 	display.setText("Time is "+hour+":"+minute+  "\n Next 3 buses are at 5:40PM, 6:45PM and 8:00PM");
	 	   }
 		 	...
 		 	display.setText("Time is "+hour+":"+minute+  "\n Next 2 buses are at 9:15PM and 9:30PM (Last Bus)");
 	   }
	 	else if(timenow>21.15 && timenow <21.30){
 		 	display.setText("Time is "+hour+":"+minute+  "\n Next bus is at 9:30PM (Last Bus)");
 	   }
	 	  
	 	   else if(timenow>21.30){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_campus_to_city_ho, menu);
		return true;
	}
